...
<head>
    ...
    <link rel="shortcut icon" href="/mdbstatic/mdb-favicon.ico">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.11.2/css/all.css" />
    <!-- Google Fonts Roboto -->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Roboto:wght@300;400;500;700&display=swap" />
    <!-- MDB -->
    <link rel="stylesheet" href="/mdbstatic/css/mdb.min.css" />
    <!-- Custom styles -->
<!--    <link rel="stylesheet" href="/mdbstatic/css/style.css" />-->
</head>
<body>
    <!--Main Navigation-->
<header>
...
<!-- Footer -->
    <!-- MDB -->
    <script type="text/javascript" src="/mdbstatic/js/mdb.min.js"></script>
    <!-- Custom scripts -->
